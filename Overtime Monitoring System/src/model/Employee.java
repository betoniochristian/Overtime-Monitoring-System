...
public class Employee extends Person {
    ...
    public boolean insertEmployee() {
        ...
        String sql = "INSERT INTO `empinfo`(`fname`, `lname`, `position`, `department`) "
                + "VALUES ('" + fName + "','" + lName + "', '" + designation + "', '" + department + "')";
    ...
    public boolean updateEmployee() {
        ...
        String sql = "UPDATE empinfo set fname='" + fName + "',lname='" + lName + "',position='" + designation + "',"
    ...
    public boolean getEmployeeDetailsViaName(String fname, String lname) {
        ...
        try {
            String sql = "SELECT * FROM empinfo WHERE fname = '" + fname + "' AND lname = '" + lname + "'";
